...
export const Cardano: CryptoCurrency = { name: 'Cardano', value: 3, marketCap: 30, circulationSupply: 32026340214, ranking: 3, imgSrc: 'https://cdn.coingape.com/wp-content/uploads/2021/07/16201528/cardano-price-10.jpg' };
export const Solana: CryptoCurrency = { name: 'Solana', value: 200, marketCap: 20, circulationSupply: 291398038, ranking: 4, imgSrc: 'https://economictimes.indiatimes.com/thumb/msid-85979185,width-1000,height-624,resizemode-4,imgsize-15388/solana-image-source-solana-com.jpg?from=mdr' };
...
export const allCryptos: CryptoCurrency[] = [ Bitcoin, Ethereum, Cardano, Solana, Polygon ];
